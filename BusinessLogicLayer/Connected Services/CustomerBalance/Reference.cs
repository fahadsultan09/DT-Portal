...
namespace CustomerBalance
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.sami.com/DP_Cust_Bal", ConfigurationName="CustomerBalance.CustPORespOut")]
    public interface CustPORespOut
    {
        ...
        CustomerBalance.CustPORespOutResponse CustPORespOut(CustomerBalance.CustPORespOutRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://sap.com/xi/WebService/soap1.1", ReplyAction="*")]
        System.Threading.Tasks.Task<CustomerBalance.CustPORespOutResponse> CustPORespOutAsync(CustomerBalance.CustPORespOutRequest request);
    }
    ...
    public partial class CustPORespOutRequest
    {
        ...
        public CustomerBalance.Cust_resp_out Cust_resp_out;
        
        public CustPORespOutRequest()
        {
        }
        
        public CustPORespOutRequest(CustomerBalance.Cust_resp_out Cust_resp_out)
        {
    ...
    public partial class CustPORespOutResponse
    {
        ...
        public CustomerBalance.ZSS_CUST_BALResponse ZSS_CUST_BALResponse;
        
        public CustPORespOutResponse()
        {
        }
        
        public CustPORespOutResponse(CustomerBalance.ZSS_CUST_BALResponse ZSS_CUST_BALResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface CustPORespOutChannel : CustomerBalance.CustPORespOut, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class CustPORespOutClient : System.ServiceModel.ClientBase<CustomerBalance.CustPORespOut>, CustomerBalance.CustPORespOut
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CustomerBalance.CustPORespOutResponse CustomerBalance.CustPORespOut.CustPORespOut(CustomerBalance.CustPORespOutRequest request)
        {
            return base.Channel.CustPORespOut(request);
        }
        
        public CustomerBalance.ZSS_CUST_BALResponse CustPORespOut(CustomerBalance.Cust_resp_out Cust_resp_out)
        {
            CustomerBalance.CustPORespOutRequest inValue = new CustomerBalance.CustPORespOutRequest();
            inValue.Cust_resp_out = Cust_resp_out;
            CustomerBalance.CustPORespOutResponse retVal = ((CustomerBalance.CustPORespOut)(this)).CustPORespOut(inValue);
            return retVal.ZSS_CUST_BALResponse;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CustomerBalance.CustPORespOutResponse> CustomerBalance.CustPORespOut.CustPORespOutAsync(CustomerBalance.CustPORespOutRequest request)
        {
            return base.Channel.CustPORespOutAsync(request);
        }
        
        public System.Threading.Tasks.Task<CustomerBalance.CustPORespOutResponse> CustPORespOutAsync(CustomerBalance.Cust_resp_out Cust_resp_out)
        {
            CustomerBalance.CustPORespOutRequest inValue = new CustomerBalance.CustPORespOutRequest();
            inValue.Cust_resp_out = Cust_resp_out;
            return ((CustomerBalance.CustPORespOut)(this)).CustPORespOutAsync(inValue);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.HTTP_Port))
            {
                return new System.ServiceModel.EndpointAddress("http://s049sappodev.samikhi.com:51000/XISOAPAdapter/MessageServlet?senderParty=&s" +
                        "enderService=NSAP_DEV&receiverParty=&receiverService=&interface=CustPORespOut&in" +
                        "terfaceNamespace=http%3A%2F%2Fwww.sami.com%2FDP_Cust_Bal");
            }
            if ((endpointConfiguration == EndpointConfiguration.HTTPS_Port))
            {
                return new System.ServiceModel.EndpointAddress("https://s049sappodev.samikhi.com:51001/XISOAPAdapter/MessageServlet?senderParty=&" +
                        "senderService=NSAP_DEV&receiverParty=&receiverService=&interface=CustPORespOut&i" +
                        "nterfaceNamespace=http%3A%2F%2Fwww.sami.com%2FDP_Cust_Bal");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
